...
//							.getString(1);
				...
				customer.setText(taskObj.getJSONArray("customer").getString(1));
               	 ATMDtails.setText(taskObj.getJSONArray("atm").toString());
               	locationText.setText(taskObj.getJSONArray("country").getString(1));
